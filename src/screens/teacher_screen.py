...
def teacher_dashboard():
    ...
    with tab1 :
        ...
        if st.button('Take_attendance',type=type1, width='stretch',icon=':material/ar_on_you:'):
            st.session_state.current_teacher_tab = "take_attendance"
            st.rerun()
...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter username",placeholder="najibur")
...
def register_teacher(teacher_username,teacher_name,teacher_password,teacher_pass_confirm):
    if not teacher_username or not teacher_name or not teacher_password :
        return False,"All Frield are required!"
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username = st.text_input("Enter username",placeholder="najibur")
    teacher_name = st.text_input("Enter name",placeholder="MD Najibur Rohman")
    teacher_password = st.text_input("Enter password",type='password',placeholder='Enter password')
